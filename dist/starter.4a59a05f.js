...
/** @type {HTMLDivElement} Reference to the `.recipe` container (legacy, kept for compatibility). */ const recipeContainer = document.querySelector('.recipe');
// if (module.hot) {
//   module.hot.accept();
// }
 ...
 */ const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        console.error(`\u{1F525}\u{1F525}${err.message}`);
 ...
 */ const controlAddIngredient = function() {
    ...
    const ingredients = _modelJs.state.recipe?.ingredients;
    ...
    (0, _shoppingListViewJsDefault.default).renderList(ingredients);
    // 3. Open the modal (View)
    (0, _shoppingListViewJsDefault.default).open();
};
/**
 ...
 */ const init = function() {
    ...
    (0, _recipeViewJsDefault.default).addHandlerIngredients(controlAddIngredient);
...
},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","./Views/recipeView.js":"lrlOm","regenerator-runtime/runtime":"f6ot0","./Views/searchView.js":"aUu1u","./Views/resultsView.js":"fYkxP","./Views/paginationView.js":"kQgXX","./Views/bookmarkView.js":"frWyw","./Views/addRecipeView.js":"ebmM2","./Views/shoppingListView.js":"zLadM","./config.js":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const updateServing = function(new_serv) {
...
const addBookmark = function(recipe) {
    ...
    if (state.bookmarks.some((bookmark)=>bookmark.id === recipe.id)) return; // Don't add duplicates
...
const Key = 'b241cdf6-789c-47bb-a083-454db8735511';
 ...
 */ class RecipeView extends (0, _viewDefault.default) {
    /** @type {HTMLElement} The DOM element this view renders into. */ _parentElement = document.querySelector('.recipe');
    /** @type {string} Default error message shown when a recipe cannot be found. */ _errorMessage = 'we could not find this recipe. please try another one';
    /** @type {string} Default success message (unused for this view). */ _message = '';
    /**
   ...
   */ _generateMarkup() {
      ...
      <div class="recipe__details">
       ...
       <!-- \u{1F6D2} NEW SHOPPING LIST BUTTON (Hardcoded SVG) -->
...
},{"./view":"4M8AP","url:../../img/icons.svg":"fd0vu","fracty":"gsPKI","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4M8AP":[function(require,module,exports,__globalThis) {
/**
...
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class View {
    /** @type {*} The data object(s) currently held by this view. */ _data;
    /**
   ...
   */ update(data) {
        ...
        newElements.forEach((newEL, i)=>{
            ...
            if (!newEL.isEqualNode(curEL) && newEL.firstChild?.nodeType === Node.TEXT_NODE && // ✅ Check it's a text node
            newEL.firstChild.nodeValue.trim() !== '') {
                console.log(`${newEL.firstChild.nodeValue.trim()}\u{1F525}\u{1F525}\u{1F525}`);
...
parcelHelpers.defineInteropFlag(exports);
class SearchView {
    /** @type {HTMLFormElement} The search form element. */ _parentElement = document.querySelector('.search');
    /**
 ...
 */ class ResultsView extends (0, _viewDefault.default) {
    /** @type {string} Error message displayed when no results match the query. */ _errorMessage = 'No recipe found for your query please try again';
    /** @type {string} */ _message = '';
    /** @type {HTMLUListElement} The `.results` list element. */ _parentElement = document.querySelector('.results');
    /**
...
},{"url:../../img/icons.svg":"fd0vu","./view":"4M8AP","./previewView":"hoVX0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hoVX0":[function(require,module,exports,__globalThis) {
/**
 ...
 */ class PreviewView extends (0, _viewDefault.default) {
    /** @type {string} Not used — PreviewView never renders directly. */ _parentElement = '';
    /**
...
},{"url:../../img/icons.svg":"fd0vu","./view":"4M8AP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kQgXX":[function(require,module,exports,__globalThis) {
/**
 ...
 */ class PaginationView extends (0, _viewDefault.default) {
    /** @type {HTMLDivElement} The pagination container element. */ _parentElement = document.querySelector('.pagination');
    /**
...
},{"url:../../img/icons.svg":"fd0vu","./view":"4M8AP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"frWyw":[function(require,module,exports,__globalThis) {
/**
 ...
 */ class bookmarkView extends (0, _viewDefault.default) {
    /** @type {string} Message shown when the user has no bookmarks yet. */ _errorMessage = 'No bookmarks yet,Find a nice recipe and bookmark it ;';
    /** @type {string} */ _message = '';
    /** @type {HTMLUListElement} The bookmarks list container. */ _parentElement = document.querySelector('.bookmarks__list');
    /**
...
},{"url:../../img/icons.svg":"fd0vu","./view":"4M8AP","./previewView":"hoVX0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"ebmM2":[function(require,module,exports,__globalThis) {
/**
 ...
 */ class addRecipeView extends (0, _viewDefault.default) {
    /** @type {HTMLFormElement} The `.upload` form element inside the modal. */ _parentElement = document.querySelector('.upload');
    /** @type {string} Success message shown after a recipe is uploaded. */ _message = 'Recipe Was Successfuly Uploaded;';
    /** @type {HTMLDivElement} The modal window element. */ _window = document.querySelector('.add-recipe-window');
    /** @type {HTMLDivElement} The dark overlay behind the modal. */ _overlay = document.querySelector('.overlay');
    /** @type {HTMLButtonElement} The "Add Recipe" nav button that opens the modal. */ _btnOpen = document.querySelector('.nav__btn--add-recipe');
    /** @type {HTMLButtonElement} The × button that closes the modal. */ _btnClose = document.querySelector('.btn--close-modal');
    /**
...
},{"url:../../img/icons.svg":"fd0vu","./view":"4M8AP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"zLadM":[function(require,module,exports,__globalThis) {
/**
 ...
 */ class ShoppingListView extends (0, _viewDefault.default) {
   ...
   */ _parentElement;
    /** @type {string} */ _message = '';
    /** @type {string} */ _errorMessage = 'No ingredients to display.';
    /**
   ...
   */ renderList(ingredients) {
        this._list.innerHTML = ingredients.map((ing)=>`<li>${ing.quantity ? ing.quantity : ''} ${ing.unit} ${ing.description}</li>`).join('');
    }
    /**
...
},{"./view":"4M8AP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5DuvQ","7dWZ8"], "7dWZ8", "parcelRequire3a11", {}, "./", "/")
